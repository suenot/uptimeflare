...
- Avoided rebuilding every monitor's latency history on each scheduled check, reducing CPU use that caused Free-plan Worker executions to exceed their limit.
